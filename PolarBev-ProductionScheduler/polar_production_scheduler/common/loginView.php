...
{
	showHeader("Login to Production Scheduling Maintenance");
?>
...
<div id="output" class="inquiry_output" style="height:100%">
...
?>
<h3>Use the same user and password as you use to log in to the IBM AS/400.</h3>
