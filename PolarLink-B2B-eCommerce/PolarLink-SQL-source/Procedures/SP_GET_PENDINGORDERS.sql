...
CREATE OR REPLACE PROCEDURE SP_GET_PENDINGORDERS ( 
	IN IN_CUSTGROUP CHAR(10) , 
	IN IN_CURRUSERID CHAR(10) , 
	OUT OUT_MESSAGE VARCHAR(100) ) 
	DYNAMIC RESULT SETS 1 
	LANGUAGE SQL 
	SPECIFIC SP_GET_PENDINGORDERS 
	NOT DETERMINISTIC 
	MODIFIES SQL DATA 
...
Retrieve pending orders to show on the home page. 
...
LEFT JOIN	RCME  -- customer master extension 
	...
	AND			PLINK_STATUS = 'CURR' 
		 -- If current user is a CSR, show all pending orders for customer group. 
...
GRANT ALTER , EXECUTE   
ON SPECIFIC PROCEDURE SP_GET_PENDINGORDERS 
TO JVALANCE ; 
