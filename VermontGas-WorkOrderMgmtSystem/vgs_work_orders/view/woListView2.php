...
<table class="lists" >
	...
	<tr>
		...
		<th class="ca" width="12%">Entry Date</th>
...
$woInq = "woEditCtrl.php?mode=inquiry&WO_NUM={$wo['WO_NUM']}";
?>
<tr <?=$rowClass?> onmouseover="$(this).addClass('hover');"  onmouseout="$(this).removeClass('hover');"
	...
	<td class="ca">
		...
		<?php 
		if ($wo['WO_STATUS'] == Workorder_Master::WO_STATUS_PENDING 
		||  $wo['WO_STATUS'] == Workorder_Master::WO_STATUS_COMPLETED):
		?>
		<a href="woEditCtrl.php?mode=update&WO_NUM=<?= $wo['WO_NUM'] ?>" >
